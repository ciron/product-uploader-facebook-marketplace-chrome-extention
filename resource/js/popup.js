...
document.getElementById("fetchProducts").addEventListener("click", async () => {
  try {
    ...
    if (!data.success) throw new Error("API returned an error.".data);
    ...
    products.forEach((product, index) => {
      ...
      listItem.style = "display: flex; align-items: center; justify-content: space-between; padding: 10px; border-bottom: 1px solid #ddd;";
